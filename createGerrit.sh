...
-e DEVELOPER1_EMAIL=${DEVELOPER1_EMAIL} \
-e DEVELOPER1_USERNAME=${DEVELOPER1_USERNAME} \
-e DEVELOPER1_PASSWORD=${DEVELOPER1_PASSWORD} \
-e DEVELOPER2_EMAIL=${DEVELOPER2_EMAIL} \
-e DEVELOPER2_USERNAME=${DEVELOPER2_USERNAME} \
-e DEVELOPER2_PASSWORD=${DEVELOPER2_PASSWORD} \
