...
docker tag codeurjc/forge-jenkins codeurjc/forge-jenkins:${DATETIME}
...
docker tag codeurjc/forge-gerrit codeurjc/forge-gerrit:${DATETIME}
...
docker tag codeurjc/forge-php-ssp codeurjc/forge-php-ssp:${DATETIME}
